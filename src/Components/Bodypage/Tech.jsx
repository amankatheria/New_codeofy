...
function Tech() {
  return (
    ...
    <>
      <div className="w-full flex justify-center items-center py-8 px-4 bg-gray-50">
        <div className="text-center py-10">

          <p className="text-black text-sm tracking-widest mb-8">
            OUR CORE TECHNOLOGY STACK
          </p>

          <div className="flex justify-center flex-wrap gap-10 text-black">
          ...
          <div className="w-full flex justify-center items-center py-6 px-6 bg-gray-50">

            <div className="max-w-5xl w-full bg-gradient-to-r from-blue-900 to-blue-700 rounded-2xl text-center p-12 shadow-xl">
