                ...
                <div className="flex flex-col items-center justify-center ">
                    ...
                    <div className=" max-w-3xl mb-15 ">
                        ...
                        <div className="flex justify-center items-center gap-x-6 mt-14 ">
                            <button onClick={handleClick} className="text-lg font-bold text-white  bg-[rgba(9,80,224,0.75)] py-4 px-9 rounded hover:cursor-pointer transition duration-300 hover:scale-105 hover:bg-linear-to-r hover:to-[rgba(100,150,250,0.5)] p-5">
                                View Open Positions
